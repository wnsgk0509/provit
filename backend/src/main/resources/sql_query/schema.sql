...
INSERT ALL
    INTO T_EDUCODE (EDUCATION_CODE, EDUCATION_NAME) VALUES (0, '학력무관')
    INTO T_EDUCODE (EDUCATION_CODE, EDUCATION_NAME) VALUES (1, '고등학교졸업')
    INTO T_EDUCODE (EDUCATION_CODE, EDUCATION_NAME) VALUES (2, '대학졸업(2,3년)')
    INTO T_EDUCODE (EDUCATION_CODE, EDUCATION_NAME) VALUES (3, '대학교졸업(4년)')
    INTO T_EDUCODE (EDUCATION_CODE, EDUCATION_NAME) VALUES (4, '석사졸업')
    INTO T_EDUCODE (EDUCATION_CODE, EDUCATION_NAME) VALUES (5, '박사졸업')
    INTO T_EDUCODE (EDUCATION_CODE, EDUCATION_NAME) VALUES (6, '고등학교졸업이상')
    INTO T_EDUCODE (EDUCATION_CODE, EDUCATION_NAME) VALUES (7, '대학졸업(2년,3년 이상)')
    INTO T_EDUCODE (EDUCATION_CODE, EDUCATION_NAME) VALUES (8, '대학교졸업(4년)이상')
    INTO T_EDUCODE (EDUCATION_CODE, EDUCATION_NAME) VALUES (9, '석사졸업이상')
SELECT 1 FROM DUAL;
...
-- 4-2. 관심 채용 공고 스크랩 (N:M 해소, 복합 기본키)
CREATE TABLE T_JOB_SCRAP (
    RECRUITMENT_NUM      NUMBER(18)          NOT NULL REFERENCES T_RECRUITMENT(RECRUITMENT_NUM) ON DELETE CASCADE,
    USER_NUM             NUMBER(9)           NOT NULL REFERENCES T_USER(USER_NUM) ON DELETE CASCADE,
    CREATED_AT           DATE                DEFAULT SYSDATE NOT NULL,
    PRIMARY KEY (RECRUITMENT_NUM, USER_NUM)
);
CREATE INDEX IDX_SCRAP_USER ON T_JOB_SCRAP(USER_NUM);
...
CREATE TABLE T_COMMENT (
    ...
    PARENT_COMMENT_NUM   NUMBER(18)          REFERENCES T_COMMENT(COMMENT_NUM),
...
CREATE TABLE T_STUDY (
    ...
    MAX_MEMBERS          NUMBER(4)           DEFAULT 10 NOT NULL,
