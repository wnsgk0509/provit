    ...
    return (
        <div className="study-section">
            <div className="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h5 className="fw-bold mb-1">🔥 면접 & 취업 스터디 그룹</h5>
                    <p className="text-muted small mb-0">함께 모의면접을 연습하고 피드백을 주고받을 스터디원을 모집하거나 참여해보세요.</p>
                </div>
                {isLoggedIn ? (
                    <button 
                        ...
                        studies.map((study) => (
                            <div className="col-md-6 col-lg-4" key={study.studyNum}>
                                <div 
                                    ...
                                    style={{ borderRadius: '1rem', transition: 'transform 0.2s', cursor: 'default' }}
                                    ...
                                    <div className="card-body p-4 d-flex flex-column">
                                        ...
                                        <div className="d-flex justify-content-between align-items-end mt-4 pt-3 border-top">
                                            <div className="text-muted small">
                                                ...
                                                <div>{study.studyCreateDate ? study.studyCreateDate.split(' ')[0] : ''} 개설</div>
                                            </div>
                                            
                                            {/* 방장인 경우 내 스터디 뱃지, 일반 유저는 참여/취소 버튼 */}
                                            {(!user || user.userNum !== study.userNum) ? (
                                                study.isJoined ? (
